...
insert into source.administrative_source_type(code, display_value, status, description) values('publicNotification', 'Public Notification for Systematic Registration::::ITALIANO', 'c', 'Extension to LADM');
insert into source.administrative_source_type(code, display_value, status, description) values('systematicRegn', 'Systematic Registration Application::::ITALIANO', 'c', 'Extension to LADM');
...
insert into system.approle(code, display_value, status, description) values('systematicRegn', 'Systematic Registration', 'c', 'Allows access to Systematic Registration');
...
ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_type_code_fk41 
            FOREIGN KEY (type_code) REFERENCES administrative.rrr_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX rrr_type_code_fk41_ind ON administrative.rrr (type_code);

ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_ba_unit_id_fk42 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE Cascade;
CREATE INDEX rrr_ba_unit_id_fk42_ind ON administrative.rrr (ba_unit_id);

ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_status_code_fk43 
            FOREIGN KEY (status_code) REFERENCES transaction.reg_status_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX rrr_status_code_fk43_ind ON administrative.rrr (status_code);

ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_transaction_id_fk44 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE Cascade;
CREATE INDEX rrr_transaction_id_fk44_ind ON administrative.rrr (transaction_id);

ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_mortgage_type_code_fk45 
            FOREIGN KEY (mortgage_type_code) REFERENCES administrative.mortgage_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX rrr_mortgage_type_code_fk45_ind ON administrative.rrr (mortgage_type_code);

ALTER TABLE administrative.mortgage_isbased_in_rrr ADD CONSTRAINT mortgage_isbased_in_rrr_rrr_id_fk46 
            FOREIGN KEY (rrr_id) REFERENCES administrative.rrr(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX mortgage_isbased_in_rrr_rrr_id_fk46_ind ON administrative.mortgage_isbased_in_rrr (rrr_id);

ALTER TABLE administrative.mortgage_isbased_in_rrr ADD CONSTRAINT mortgage_isbased_in_rrr_mortgage_id_fk47 
            FOREIGN KEY (mortgage_id) REFERENCES administrative.rrr(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX mortgage_isbased_in_rrr_mortgage_id_fk47_ind ON administrative.mortgage_isbased_in_rrr (mortgage_id);

ALTER TABLE administrative.source_describes_rrr ADD CONSTRAINT source_describes_rrr_rrr_id_fk48 
            FOREIGN KEY (rrr_id) REFERENCES administrative.rrr(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX source_describes_rrr_rrr_id_fk48_ind ON administrative.source_describes_rrr (rrr_id);

ALTER TABLE administrative.source_describes_rrr ADD CONSTRAINT source_describes_rrr_source_id_fk49 
            FOREIGN KEY (source_id) REFERENCES source.source(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX source_describes_rrr_source_id_fk49_ind ON administrative.source_describes_rrr (source_id);

ALTER TABLE administrative.source_describes_ba_unit ADD CONSTRAINT source_describes_ba_unit_ba_unit_id_fk50 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX source_describes_ba_unit_ba_unit_id_fk50_ind ON administrative.source_describes_ba_unit (ba_unit_id);

ALTER TABLE administrative.source_describes_ba_unit ADD CONSTRAINT source_describes_ba_unit_source_id_fk51 
            FOREIGN KEY (source_id) REFERENCES source.source(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX source_describes_ba_unit_source_id_fk51_ind ON administrative.source_describes_ba_unit (source_id);

ALTER TABLE administrative.required_relationship_baunit ADD CONSTRAINT required_relationship_baunit_from_ba_unit_id_fk52 
            FOREIGN KEY (from_ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX required_relationship_baunit_from_ba_unit_id_fk52_ind ON administrative.required_relationship_baunit (from_ba_unit_id);

ALTER TABLE administrative.required_relationship_baunit ADD CONSTRAINT required_relationship_baunit_to_ba_unit_id_fk53 
            FOREIGN KEY (to_ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX required_relationship_baunit_to_ba_unit_id_fk53_ind ON administrative.required_relationship_baunit (to_ba_unit_id);

ALTER TABLE administrative.required_relationship_baunit ADD CONSTRAINT required_relationship_baunit_relation_code_fk54 
            FOREIGN KEY (relation_code) REFERENCES administrative.ba_unit_rel_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX required_relationship_baunit_relation_code_fk54_ind ON administrative.required_relationship_baunit (relation_code);

ALTER TABLE cadastre.spatial_unit ADD CONSTRAINT spatial_unit_dimension_code_fk55 
            FOREIGN KEY (dimension_code) REFERENCES cadastre.dimension_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX spatial_unit_dimension_code_fk55_ind ON cadastre.spatial_unit (dimension_code);

ALTER TABLE cadastre.spatial_unit ADD CONSTRAINT spatial_unit_surface_relation_code_fk56 
            FOREIGN KEY (surface_relation_code) REFERENCES cadastre.surface_relation_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX spatial_unit_surface_relation_code_fk56_ind ON cadastre.spatial_unit (surface_relation_code);

ALTER TABLE cadastre.spatial_unit ADD CONSTRAINT spatial_unit_level_id_fk57 
            FOREIGN KEY (level_id) REFERENCES cadastre.level(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX spatial_unit_level_id_fk57_ind ON cadastre.spatial_unit (level_id);

ALTER TABLE cadastre.level ADD CONSTRAINT level_register_type_code_fk58 
            FOREIGN KEY (register_type_code) REFERENCES cadastre.register_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX level_register_type_code_fk58_ind ON cadastre.level (register_type_code);

ALTER TABLE cadastre.level ADD CONSTRAINT level_structure_code_fk59 
            FOREIGN KEY (structure_code) REFERENCES cadastre.structure_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX level_structure_code_fk59_ind ON cadastre.level (structure_code);

ALTER TABLE cadastre.level ADD CONSTRAINT level_type_code_fk60 
            FOREIGN KEY (type_code) REFERENCES cadastre.level_content_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX level_type_code_fk60_ind ON cadastre.level (type_code);
...
ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_type_code_fk62 
            FOREIGN KEY (type_code) REFERENCES cadastre.cadastre_object_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_type_code_fk62_ind ON cadastre.cadastre_object (type_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_status_code_fk63 
            FOREIGN KEY (status_code) REFERENCES transaction.reg_status_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_status_code_fk63_ind ON cadastre.cadastre_object (status_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_building_unit_type_code_fk64 
            FOREIGN KEY (building_unit_type_code) REFERENCES cadastre.building_unit_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_building_unit_type_code_fk64_ind ON cadastre.cadastre_object (building_unit_type_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_transaction_id_fk65 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE Cascade;
CREATE INDEX cadastre_object_transaction_id_fk65_ind ON cadastre.cadastre_object (transaction_id);

ALTER TABLE cadastre.spatial_unit ADD CONSTRAINT spatial_unit_land_use_code_fk66 
            FOREIGN KEY (land_use_code) REFERENCES cadastre.land_use_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX spatial_unit_land_use_code_fk66_ind ON cadastre.spatial_unit (land_use_code);

ALTER TABLE administrative.ba_unit_contains_spatial_unit ADD CONSTRAINT ba_unit_contains_spatial_unit_ba_unit_id_fk67 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX ba_unit_contains_spatial_unit_ba_unit_id_fk67_ind ON administrative.ba_unit_contains_spatial_unit (ba_unit_id);

ALTER TABLE administrative.ba_unit_contains_spatial_unit ADD CONSTRAINT ba_unit_contains_spatial_unit_spatial_unit_id_fk68 
...
ALTER TABLE cadastre.spatial_value_area ADD CONSTRAINT spatial_value_area_spatial_unit_id_fk84 
            FOREIGN KEY (spatial_unit_id) REFERENCES cadastre.spatial_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_value_area_spatial_unit_id_fk84_ind ON cadastre.spatial_value_area (spatial_unit_id);

ALTER TABLE cadastre.spatial_value_area ADD CONSTRAINT spatial_value_area_type_code_fk85 
            FOREIGN KEY (type_code) REFERENCES cadastre.area_type(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_value_area_type_code_fk85_ind ON cadastre.spatial_value_area (type_code);

ALTER TABLE cadastre.spatial_unit_address ADD CONSTRAINT spatial_unit_address_spatial_unit_id_fk86 
            FOREIGN KEY (spatial_unit_id) REFERENCES cadastre.spatial_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_address_spatial_unit_id_fk86_ind ON cadastre.spatial_unit_address (spatial_unit_id);

ALTER TABLE cadastre.spatial_unit_address ADD CONSTRAINT spatial_unit_address_address_id_fk87 
            FOREIGN KEY (address_id) REFERENCES address.address(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_address_address_id_fk87_ind ON cadastre.spatial_unit_address (address_id);

ALTER TABLE cadastre.spatial_unit_group ADD CONSTRAINT spatial_unit_group_found_in_spatial_unit_group_id_fk88 
...
CREATE INDEX spatial_unit_group_found_in_spatial_unit_group_id_fk88_ind ON cadastre.spatial_unit_group (found_in_spatial_unit_group_id);

ALTER TABLE cadastre.spatial_unit_in_group ADD CONSTRAINT spatial_unit_in_group_spatial_unit_group_id_fk89 
            FOREIGN KEY (spatial_unit_group_id) REFERENCES cadastre.spatial_unit_group(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_in_group_spatial_unit_group_id_fk89_ind ON cadastre.spatial_unit_in_group (spatial_unit_group_id);

ALTER TABLE cadastre.spatial_unit_in_group ADD CONSTRAINT spatial_unit_in_group_spatial_unit_id_fk90 
            FOREIGN KEY (spatial_unit_id) REFERENCES cadastre.spatial_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE INDEX legal_space_utility_network_status_code_fk92_ind ON cadastre.legal_space_utility_network (status_code);

ALTER TABLE cadastre.legal_space_utility_network ADD CONSTRAINT legal_space_utility_network_type_code_fk93 
...
ALTER TABLE transaction.transaction_source ADD CONSTRAINT transaction_source_transaction_id_fk97 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX transaction_source_transaction_id_fk97_ind ON transaction.transaction_source (transaction_id);

ALTER TABLE transaction.transaction_source ADD CONSTRAINT transaction_source_source_id_fk98 
            FOREIGN KEY (source_id) REFERENCES source.source(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX transaction_source_source_id_fk98_ind ON transaction.transaction_source (source_id);

ALTER TABLE cadastre.cadastre_object_node_target ADD CONSTRAINT cadastre_object_node_target_transaction_id_fk99 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX cadastre_object_node_target_transaction_id_fk99_ind ON cadastre.cadastre_object_node_target (transaction_id);

ALTER TABLE application.application_property ADD CONSTRAINT application_property_application_id_fk100 
            FOREIGN KEY (application_id) REFERENCES application.application(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_property_application_id_fk100_ind ON application.application_property (application_id);

ALTER TABLE application.application_property ADD CONSTRAINT application_property_ba_unit_id_fk101 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_property_ba_unit_id_fk101_ind ON application.application_property (ba_unit_id);

ALTER TABLE application.application_property ADD CONSTRAINT application_property_land_use_code_fk102 
            FOREIGN KEY (land_use_code) REFERENCES cadastre.land_use_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_property_land_use_code_fk102_ind ON application.application_property (land_use_code);

ALTER TABLE application.application_uses_source ADD CONSTRAINT application_uses_source_application_id_fk103 
            FOREIGN KEY (application_id) REFERENCES application.application(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX application_uses_source_application_id_fk103_ind ON application.application_uses_source (application_id);

ALTER TABLE application.application_uses_source ADD CONSTRAINT application_uses_source_source_id_fk104 
            FOREIGN KEY (source_id) REFERENCES source.source(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX application_uses_source_source_id_fk104_ind ON application.application_uses_source (source_id);

ALTER TABLE application.request_type_requires_source_type ADD CONSTRAINT request_type_requires_source_type_source_type_code_fk105 
            FOREIGN KEY (source_type_code) REFERENCES source.administrative_source_type(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX request_type_requires_source_type_source_type_code_fk105_ind ON application.request_type_requires_source_type (source_type_code);

ALTER TABLE application.request_type_requires_source_type ADD CONSTRAINT request_type_requires_source_type_request_type_code_fk106 
            FOREIGN KEY (request_type_code) REFERENCES application.request_type(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX request_type_requires_source_type_request_type_code_fk106_ind ON application.request_type_requires_source_type (request_type_code);

ALTER TABLE system.appuser_setting ADD CONSTRAINT appuser_setting_user_id_fk107 
            FOREIGN KEY (user_id) REFERENCES system.appuser(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX appuser_setting_user_id_fk107_ind ON system.appuser_setting (user_id);

ALTER TABLE system.config_map_layer ADD CONSTRAINT config_map_layer_type_code_fk108 
            FOREIGN KEY (type_code) REFERENCES system.config_map_layer_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX config_map_layer_type_code_fk108_ind ON system.config_map_layer (type_code);

ALTER TABLE system.config_map_layer ADD CONSTRAINT config_map_layer_pojo_query_name_fk109 
            FOREIGN KEY (pojo_query_name) REFERENCES system.query(name) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX config_map_layer_pojo_query_name_fk109_ind ON system.config_map_layer (pojo_query_name);

ALTER TABLE system.config_map_layer ADD CONSTRAINT config_map_layer_pojo_query_name_for_select_fk110 
            FOREIGN KEY (pojo_query_name_for_select) REFERENCES system.query(name) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX config_map_layer_pojo_query_name_for_select_fk110_ind ON system.config_map_layer (pojo_query_name_for_select);

ALTER TABLE system.br ADD CONSTRAINT br_technical_type_code_fk111 
            FOREIGN KEY (technical_type_code) REFERENCES system.br_technical_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_technical_type_code_fk111_ind ON system.br (technical_type_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_br_id_fk112 
            FOREIGN KEY (br_id) REFERENCES system.br(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_br_id_fk112_ind ON system.br_validation (br_id);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_severity_code_fk113 
            FOREIGN KEY (severity_code) REFERENCES system.br_severity_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_severity_code_fk113_ind ON system.br_validation (severity_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_code_fk114 
            FOREIGN KEY (target_code) REFERENCES system.br_validation_target_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_code_fk114_ind ON system.br_validation (target_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_request_type_code_fk115 
            FOREIGN KEY (target_request_type_code) REFERENCES application.request_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_request_type_code_fk115_ind ON system.br_validation (target_request_type_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_rrr_type_code_fk116 
            FOREIGN KEY (target_rrr_type_code) REFERENCES administrative.rrr_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_rrr_type_code_fk116_ind ON system.br_validation (target_rrr_type_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_application_moment_fk117 
...
CREATE INDEX br_validation_target_application_moment_fk117_ind ON system.br_validation (target_application_moment);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_service_moment_fk118 
            FOREIGN KEY (target_service_moment) REFERENCES application.service_action_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_service_moment_fk118_ind ON system.br_validation (target_service_moment);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_reg_moment_fk119 
            FOREIGN KEY (target_reg_moment) REFERENCES transaction.reg_status_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_reg_moment_fk119_ind ON system.br_validation (target_reg_moment);

ALTER TABLE system.br_definition ADD CONSTRAINT br_definition_br_id_fk120 
            FOREIGN KEY (br_id) REFERENCES system.br(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX br_definition_br_id_fk120_ind ON system.br_definition (br_id);

ALTER TABLE system.approle_appgroup ADD CONSTRAINT approle_appgroup_approle_code_fk121 
            FOREIGN KEY (approle_code) REFERENCES system.approle(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX approle_appgroup_approle_code_fk121_ind ON system.approle_appgroup (approle_code);

ALTER TABLE system.approle_appgroup ADD CONSTRAINT approle_appgroup_appgroup_id_fk122 
            FOREIGN KEY (appgroup_id) REFERENCES system.appgroup(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX approle_appgroup_appgroup_id_fk122_ind ON system.approle_appgroup (appgroup_id);

ALTER TABLE system.appuser_appgroup ADD CONSTRAINT appuser_appgroup_appuser_id_fk123 
            FOREIGN KEY (appuser_id) REFERENCES system.appuser(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX appuser_appgroup_appuser_id_fk123_ind ON system.appuser_appgroup (appuser_id);

ALTER TABLE system.appuser_appgroup ADD CONSTRAINT appuser_appgroup_appgroup_id_fk124 
            FOREIGN KEY (appgroup_id) REFERENCES system.appgroup(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX appuser_appgroup_appgroup_id_fk124_ind ON system.appuser_appgroup (appgroup_id);

ALTER TABLE system.query_field ADD CONSTRAINT query_field_query_name_fk125 
            FOREIGN KEY (query_name) REFERENCES system.query(name) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX query_field_query_name_fk125_ind ON system.query_field (query_name);

ALTER TABLE system.map_search_option ADD CONSTRAINT map_search_option_query_name_fk126 
            FOREIGN KEY (query_name) REFERENCES system.query(name) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX map_search_option_query_name_fk126_ind ON system.map_search_option (query_name);
...
CREATE VIEW administrative.sys_reg_owner_name AS SELECT (pp.name::text || ' '::text) || COALESCE(pp.last_name, ''::character varying)::text AS value, co.id, co.name_firstpart, co.name_lastpart, COALESCE(ap.land_use_code, 'residential'::character varying) AS land_use_code, su.ba_unit_id, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'residential'::text THEN sa.size
                    ELSE 0::numeric
                END AS residential, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'agricultural'::text THEN sa.size
                    ELSE 0::numeric
                END AS agricultural, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'commercial'::text THEN sa.size
                    ELSE 0::numeric
                END AS commercial, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'industrial'::text THEN sa.size
                    ELSE 0::numeric
                END AS industrial
           FROM cadastre.cadastre_object co, cadastre.spatial_value_area sa, administrative.ba_unit_contains_spatial_unit su, application.application_property ap, application.application aa, application.service s, party.party pp, administrative.party_for_rrr pr, administrative.rrr rrr
          WHERE sa.spatial_unit_id::text = co.id::text AND sa.type_code::text = 'officialArea'::text AND su.spatial_unit_id::text = sa.spatial_unit_id::text AND ap.ba_unit_id::text = su.ba_unit_id::text AND aa.id::text = ap.application_id::text AND s.application_id::text = aa.id::text AND s.request_type_code::text = 'systematicRegn'::text AND s.status_code::text = 'completed'::text AND pp.id::text = pr.party_id::text AND pr.rrr_id::text = rrr.id::text AND rrr.ba_unit_id::text = su.ba_unit_id::text AND (rrr.type_code::text = 'ownership'::text OR rrr.type_code::text = 'apartment'::text OR rrr.type_code::text = 'commonOwnership'::text)
UNION 
         SELECT DISTINCT 'No Claimant '::text AS value, co.id, co.name_firstpart, co.name_lastpart, COALESCE(ap.land_use_code, 'residential'::character varying) AS land_use_code, su.ba_unit_id, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'residential'::text THEN sa.size
                    ELSE 0::numeric
                END AS residential, 
                ...
                CASE
                    ...
                    ELSE 0::numeric
                END AS industrial
           FROM cadastre.cadastre_object co, cadastre.spatial_value_area sa, administrative.ba_unit_contains_spatial_unit su, application.application_property ap, application.application aa, party.party pp, administrative.party_for_rrr pr, administrative.rrr rrr, application.service s
          WHERE sa.spatial_unit_id::text = co.id::text AND sa.type_code::text = 'officialArea'::text AND su.spatial_unit_id::text = sa.spatial_unit_id::text AND ap.ba_unit_id::text = su.ba_unit_id::text AND aa.id::text = ap.application_id::text AND NOT (su.ba_unit_id::text IN ( SELECT rrr.ba_unit_id
...
CREATE VIEW administrative.sys_reg_state_land AS SELECT (pp.name::text || ' '::text) || COALESCE(pp.last_name, ' '::character varying)::text AS value, co.id, co.name_firstpart, co.name_lastpart, COALESCE(ap.land_use_code, 'residential'::character varying) AS land_use_code, su.ba_unit_id, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'residential'::text THEN sa.size
                    ELSE 0::numeric
                END AS residential, 
                ...
                END AS industrial
           FROM cadastre.cadastre_object co, cadastre.spatial_value_area sa, administrative.ba_unit_contains_spatial_unit su, application.application_property ap, application.application aa, application.service s, party.party pp, administrative.party_for_rrr pr, administrative.rrr rrr
          WHERE sa.spatial_unit_id::text = co.id::text AND sa.type_code::text = 'officialArea'::text AND su.spatial_unit_id::text = sa.spatial_unit_id::text AND ap.ba_unit_id::text = su.ba_unit_id::text AND aa.id::text = ap.application_id::text AND s.application_id::text = aa.id::text AND s.request_type_code::text = 'systematicRegn'::text AND s.status_code::text = 'completed'::text AND pp.id::text = pr.party_id::text AND pr.rrr_id::text = rrr.id::text AND rrr.ba_unit_id::text = su.ba_unit_id::text AND rrr.type_code::text = 'stateOwnership'::text
UNION 
         SELECT DISTINCT 'No Claimant '::text AS value, co.id, co.name_firstpart, co.name_lastpart, COALESCE(ap.land_use_code, 'residential'::character varying) AS land_use_code, su.ba_unit_id, 
                CASE
                    WHEN COALESCE(ap.land_use_code, 'residential'::character varying)::text = 'residential'::text THEN sa.size
          ...
          WHERE sa.spatial_unit_id::text = co.id::text AND sa.type_code::text = 'officialArea'::text AND su.spatial_unit_id::text = sa.spatial_unit_id::text AND ap.ba_unit_id::text = su.ba_unit_id::text AND aa.id::text = ap.application_id::text AND NOT (su.ba_unit_id::text IN ( SELECT rrr.ba_unit_id
                   FROM administrative.rrr rrr, party.party pp, administrative.party_for_rrr pr
                  WHERE (rrr.type_code::text = 'stateOwnership'::text OR rrr.type_code::text = 'ownership'::text OR rrr.type_code::text = 'apartment'::text OR rrr.type_code::text = 'commonOwnership'::text) AND pp.id::text = pr.party_id::text AND pr.rrr_id::text = rrr.id::text)) AND s.application_id::text = aa.id::text AND s.request_type_code::text = 'systematicRegn'::text AND s.status_code::text = 'completed'::text
  ORDER BY 1;
