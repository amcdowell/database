...
ALTER TABLE cadastre.spatial_value_area ADD CONSTRAINT spatial_value_area_spatial_unit_id_fk85 
            FOREIGN KEY (spatial_unit_id) REFERENCES cadastre.spatial_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_value_area_spatial_unit_id_fk85_ind ON cadastre.spatial_value_area (spatial_unit_id);

ALTER TABLE cadastre.spatial_value_area ADD CONSTRAINT spatial_value_area_type_code_fk86 
            FOREIGN KEY (type_code) REFERENCES cadastre.area_type(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_value_area_type_code_fk86_ind ON cadastre.spatial_value_area (type_code);

ALTER TABLE cadastre.spatial_unit_address ADD CONSTRAINT spatial_unit_address_spatial_unit_id_fk87 
            FOREIGN KEY (spatial_unit_id) REFERENCES cadastre.spatial_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_address_spatial_unit_id_fk87_ind ON cadastre.spatial_unit_address (spatial_unit_id);

ALTER TABLE cadastre.spatial_unit_address ADD CONSTRAINT spatial_unit_address_address_id_fk88 
            FOREIGN KEY (address_id) REFERENCES address.address(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_address_address_id_fk88_ind ON cadastre.spatial_unit_address (address_id);

ALTER TABLE cadastre.spatial_unit_group ADD CONSTRAINT spatial_unit_group_found_in_spatial_unit_group_id_fk89 
...
CREATE INDEX spatial_unit_group_found_in_spatial_unit_group_id_fk89_ind ON cadastre.spatial_unit_group (found_in_spatial_unit_group_id);

ALTER TABLE cadastre.spatial_unit_in_group ADD CONSTRAINT spatial_unit_in_group_spatial_unit_group_id_fk90 
            FOREIGN KEY (spatial_unit_group_id) REFERENCES cadastre.spatial_unit_group(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_in_group_spatial_unit_group_id_fk90_ind ON cadastre.spatial_unit_in_group (spatial_unit_group_id);

ALTER TABLE cadastre.spatial_unit_in_group ADD CONSTRAINT spatial_unit_in_group_spatial_unit_id_fk91 
            FOREIGN KEY (spatial_unit_id) REFERENCES cadastre.spatial_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_in_group_spatial_unit_id_fk91_ind ON cadastre.spatial_unit_in_group (spatial_unit_id);

ALTER TABLE cadastre.legal_space_utility_network ADD CONSTRAINT legal_space_utility_network_id_fk92 
            FOREIGN KEY (id) REFERENCES cadastre.cadastre_object(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX legal_space_utility_network_id_fk92_ind ON cadastre.legal_space_utility_network (id);

ALTER TABLE cadastre.legal_space_utility_network ADD CONSTRAINT legal_space_utility_network_status_code_fk93 
            FOREIGN KEY (status_code) REFERENCES cadastre.utility_network_status_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX legal_space_utility_network_status_code_fk93_ind ON cadastre.legal_space_utility_network (status_code);

ALTER TABLE cadastre.legal_space_utility_network ADD CONSTRAINT legal_space_utility_network_type_code_fk94 
            FOREIGN KEY (type_code) REFERENCES cadastre.utility_network_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX legal_space_utility_network_type_code_fk94_ind ON cadastre.legal_space_utility_network (type_code);
...
ALTER TABLE cadastre.cadastre_object_target ADD CONSTRAINT cadastre_object_target_transaction_id_fk96 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX cadastre_object_target_transaction_id_fk96_ind ON cadastre.cadastre_object_target (transaction_id);
...
ALTER TABLE cadastre.cadastre_object_node_target ADD CONSTRAINT cadastre_object_node_target_transaction_id_fk100 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX cadastre_object_node_target_transaction_id_fk100_ind ON cadastre.cadastre_object_node_target (transaction_id);

ALTER TABLE application.application_property ADD CONSTRAINT application_property_application_id_fk101 
            FOREIGN KEY (application_id) REFERENCES application.application(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_property_application_id_fk101_ind ON application.application_property (application_id);

ALTER TABLE application.application_property ADD CONSTRAINT application_property_ba_unit_id_fk102 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_property_ba_unit_id_fk102_ind ON application.application_property (ba_unit_id);

ALTER TABLE application.application_property ADD CONSTRAINT application_property_land_use_code_fk103 
            FOREIGN KEY (land_use_code) REFERENCES cadastre.land_use_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_property_land_use_code_fk103_ind ON application.application_property (land_use_code);
...
ALTER TABLE system.appuser_setting ADD CONSTRAINT appuser_setting_user_id_fk108 
            FOREIGN KEY (user_id) REFERENCES system.appuser(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX appuser_setting_user_id_fk108_ind ON system.appuser_setting (user_id);

ALTER TABLE system.config_map_layer ADD CONSTRAINT config_map_layer_type_code_fk109 
            FOREIGN KEY (type_code) REFERENCES system.config_map_layer_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX config_map_layer_type_code_fk109_ind ON system.config_map_layer (type_code);
...
ALTER TABLE system.br ADD CONSTRAINT br_technical_type_code_fk112 
            FOREIGN KEY (technical_type_code) REFERENCES system.br_technical_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_technical_type_code_fk112_ind ON system.br (technical_type_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_br_id_fk113 
            FOREIGN KEY (br_id) REFERENCES system.br(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_br_id_fk113_ind ON system.br_validation (br_id);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_severity_code_fk114 
            FOREIGN KEY (severity_code) REFERENCES system.br_severity_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_severity_code_fk114_ind ON system.br_validation (severity_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_code_fk115 
            FOREIGN KEY (target_code) REFERENCES system.br_validation_target_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_code_fk115_ind ON system.br_validation (target_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_request_type_code_fk116 
            FOREIGN KEY (target_request_type_code) REFERENCES application.request_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_request_type_code_fk116_ind ON system.br_validation (target_request_type_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_rrr_type_code_fk117 
            FOREIGN KEY (target_rrr_type_code) REFERENCES administrative.rrr_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_rrr_type_code_fk117_ind ON system.br_validation (target_rrr_type_code);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_application_moment_fk118 
...
CREATE INDEX br_validation_target_application_moment_fk118_ind ON system.br_validation (target_application_moment);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_service_moment_fk119 
            FOREIGN KEY (target_service_moment) REFERENCES application.service_action_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_service_moment_fk119_ind ON system.br_validation (target_service_moment);

ALTER TABLE system.br_validation ADD CONSTRAINT br_validation_target_reg_moment_fk120 
            FOREIGN KEY (target_reg_moment) REFERENCES transaction.reg_status_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_validation_target_reg_moment_fk120_ind ON system.br_validation (target_reg_moment);

ALTER TABLE system.br_definition ADD CONSTRAINT br_definition_br_id_fk121 
            FOREIGN KEY (br_id) REFERENCES system.br(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX br_definition_br_id_fk121_ind ON system.br_definition (br_id);

ALTER TABLE system.approle_appgroup ADD CONSTRAINT approle_appgroup_approle_code_fk122 
            FOREIGN KEY (approle_code) REFERENCES system.approle(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX approle_appgroup_approle_code_fk122_ind ON system.approle_appgroup (approle_code);

ALTER TABLE system.approle_appgroup ADD CONSTRAINT approle_appgroup_appgroup_id_fk123 
            FOREIGN KEY (appgroup_id) REFERENCES system.appgroup(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX approle_appgroup_appgroup_id_fk123_ind ON system.approle_appgroup (appgroup_id);

ALTER TABLE system.appuser_appgroup ADD CONSTRAINT appuser_appgroup_appuser_id_fk124 
            FOREIGN KEY (appuser_id) REFERENCES system.appuser(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX appuser_appgroup_appuser_id_fk124_ind ON system.appuser_appgroup (appuser_id);

ALTER TABLE system.appuser_appgroup ADD CONSTRAINT appuser_appgroup_appgroup_id_fk125 
            FOREIGN KEY (appgroup_id) REFERENCES system.appgroup(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX appuser_appgroup_appgroup_id_fk125_ind ON system.appuser_appgroup (appgroup_id);

ALTER TABLE system.query_field ADD CONSTRAINT query_field_query_name_fk126 
            FOREIGN KEY (query_name) REFERENCES system.query(name) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX query_field_query_name_fk126_ind ON system.query_field (query_name);

ALTER TABLE system.map_search_option ADD CONSTRAINT map_search_option_query_name_fk127 
            FOREIGN KEY (query_name) REFERENCES system.query(name) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX map_search_option_query_name_fk127_ind ON system.map_search_option (query_name);

ALTER TABLE bulk_operation.spatial_unit_temporary ADD CONSTRAINT spatial_unit_temporary_transaction_id_fk128 
            FOREIGN KEY (transaction_id) REFERENCES transaction.transaction(id) ON UPDATE CASCADE ON DELETE Cascade;
CREATE INDEX spatial_unit_temporary_transaction_id_fk128_ind ON bulk_operation.spatial_unit_temporary (transaction_id);

ALTER TABLE bulk_operation.spatial_unit_temporary ADD CONSTRAINT spatial_unit_temporary_cadastre_object_type_code_fk129 
            FOREIGN KEY (cadastre_object_type_code) REFERENCES cadastre.cadastre_object_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX spatial_unit_temporary_cadastre_object_type_code_fk129_ind ON bulk_operation.spatial_unit_temporary (cadastre_object_type_code);
