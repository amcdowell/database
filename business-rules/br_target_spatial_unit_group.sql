...
VALUES ('spatial-unit-group-inside-other-spatial-unit-group', 'spatial_unit_group', '', 'critical', 2);
...
INSERT INTO system.br_validation(br_id, target_code, target_application_moment, severity_code, order_of_execution) 
VALUES ('spatial-unit-group-name-unique', 'spatial_unit_group', '', 'critical', 1);
...
INSERT INTO system.br_validation(br_id, target_code, target_application_moment, severity_code, order_of_execution) 
VALUES ('spatial-unit-group-not-overlap', 'spatial_unit_group', '', 'critical', 2);
